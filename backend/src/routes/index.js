...
router.get('/starpi/films/', (req, res) => {
    res.send({
        "count": 6,
        "next": null,
        "previous": null,
...
router.get('/starpi/planets', (req, res) => {
    res.send(
